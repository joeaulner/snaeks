...
var _user$project$World$square = F3(
	function (dim, attr, children) {
		var dim_ = _elm_lang$core$Basics$toString(dim);
		var attr_ = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$width(dim_),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(dim_),
				_1: attr
			}
		};
		return A2(_elm_lang$svg$Svg$rect, attr_, children);
	});
var _user$project$World$tileWidth = 14;
var _user$project$World$segment = F2(
	function (color, vector) {
		return A3(
			_user$project$World$square,
			_user$project$World$tileWidth,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$x(
					_elm_lang$core$Basics$toString(vector.x * _user$project$World$tileWidth)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$y(
						_elm_lang$core$Basics$toString(vector.y * _user$project$World$tileWidth)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill(color),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$stroke('#eeeeec'),
							_1: {
								ctor: '::',
...
var _user$project$World$snake = function (world) {
	return A2(
		_elm_lang$svg$Svg$g,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			_user$project$World$segment('purple'),
			world.snake));
};
var _user$project$World$worldSize = 32;
var _user$project$World$map = A3(
	_user$project$World$square,
	_user$project$World$worldSize * _user$project$World$tileWidth,
	{
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$fill('#3465a4'),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _user$project$World$gameObjects = function (world) {
	return A2(
		_elm_lang$svg$Svg$g,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$transform(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_user$project$World$worldSize * _user$project$World$tileWidth),
						') scale(1, -1)'))),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$World$snake(world),
			_1: {ctor: '[]'}
		});
};
var _user$project$World$view = function (world) {
	var dim = _elm_lang$core$Basics$toString(_user$project$World$worldSize * _user$project$World$tileWidth);
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$height(dim),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$width(dim),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$viewBox(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								dim,
								A2(_elm_lang$core$Basics_ops['++'], ' ', dim)))),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			ctor: '::',
			_0: _user$project$World$map,
			_1: {
				ctor: '::',
				_0: _user$project$World$gameObjects(world),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$World$init = _user$project$World$World(
	{ctor: '[]'});
var _user$project$World$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$World$snakeDecoder = _elm_lang$core$Json_Decode$list(
	A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$World$Point,
...
var _user$project$World$update = F2(
	function (json, world) {
		var _p0 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$World$snakeDecoder, json);
		if (_p0.ctor === 'Ok') {
			return _elm_lang$core$Native_Utils.update(
				world,
				{snake: _p0._0});
		} else {
			var _p1 = A2(_elm_lang$core$Debug$log, 'Invalid socket message', _p0._0);
			return world;
		}
	});

var _user$project$Snaeks$sendMessage = F2(
	function (model, str) {
		return A2(
			_elm_lang$websocket$WebSocket$send,
			A2(_elm_lang$core$Basics_ops['++'], 'ws://localhost:5000/game?name=', model.name),
			str);
	});
var _user$project$Snaeks$handleUserInput = F2(
	function (model, keyCode) {
		var send = _user$project$Snaeks$sendMessage(model);
...
var _user$project$Snaeks$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'NameInput':
			...
			case 'JoinGame':
				return (_elm_lang$core$Native_Utils.cmp(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{nameError: 'Screen name must be at least 3 characters'}),
					{ctor: '[]'}) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{started: true, nameError: ''}),
					{ctor: '[]'});
			case 'GameTick':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							world: A2(_user$project$World$update, _p1._0, model.world)
						}),
					{ctor: '[]'});
			default:
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Snaeks$handleUserInput, model, _p1._0),
						_1: {ctor: '[]'}
					});
		}
	});
var _user$project$Snaeks$Model = F4(
	function (a, b, c, d) {
		return {name: a, nameError: b, started: c, world: d};
	});
var _user$project$Snaeks$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	A4(_user$project$Snaeks$Model, '', '', false, _user$project$World$init),
	{ctor: '[]'});
var _user$project$Snaeks$UserInput = function (a) {
	return {ctor: 'UserInput', _0: a};
};
var _user$project$Snaeks$GameTick = function (a) {
	return {ctor: 'GameTick', _0: a};
};
var _user$project$Snaeks$subscriptions = function (model) {
	if (model.started) {
		var keyboard = _elm_lang$keyboard$Keyboard$presses(_user$project$Snaeks$UserInput);
		var webSocket = A2(
			_elm_lang$websocket$WebSocket$listen,
			A2(_elm_lang$core$Basics_ops['++'], 'ws://localhost:5000/game?name=', model.name),
			_user$project$Snaeks$GameTick);
...
var _user$project$Snaeks$JoinGame = {ctor: 'JoinGame'};
var _user$project$Snaeks$NameInput = function (a) {
	return {ctor: 'NameInput', _0: a};
};
var _user$project$Snaeks$view = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://github.com/pancakeCaptain/snaeks'),
					_1: {
						ctor: '::',
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('fork-me'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$alt('Fork me on GitHub'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$src('http://localhost:5000/images/fork-me.png'),
									_1: {ctor: '[]'}
								}
							}
						},
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Welcome to Snæks!'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Use WASD to move'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Press [SPACE] to start'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
				...
				_1: {
					ctor: '::',
					_0: model.started ? _user$project$World$view(model.world) : A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Screen Name'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Snaeks$NameInput),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Snaeks$JoinGame),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$core$String$isEmpty(model.nameError) ? _elm_lang$html$Html$text('') : A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
...
var _user$project$Snaeks$main = _elm_lang$html$Html$program(
	{init: _user$project$Snaeks$init, update: _user$project$Snaeks$update, subscriptions: _user$project$Snaeks$subscriptions, view: _user$project$Snaeks$view})();
var _user$project$Snaeks$West = {ctor: 'West'};
var _user$project$Snaeks$South = {ctor: 'South'};
var _user$project$Snaeks$East = {ctor: 'East'};
var _user$project$Snaeks$North = {ctor: 'North'};

var Elm = {};
Elm['Snaeks'] = Elm['Snaeks'] || {};
if (typeof _user$project$Snaeks$main !== 'undefined') {
    _user$project$Snaeks$main(Elm['Snaeks'], 'Snaeks', undefined);
}
